        ...
        <section id="projects" className="py-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="glass-card rounded-2xl overflow-hidden group fade-in-up">
                    <Image src="https://placehold.co/600x400/1e1b4b/9333ea?text=Proyek+A" alt="Gambar Proyek A" width={600} height={400} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" />
                    <div className="p-6">
                        <h3 className="text-xl font-bold mb-2">Aplikasi SaaS Inovatif</h3>
                        <p className="text-gray-400 mb-4 text-sm">Platform manajemen proyek berbasis cloud dengan fitur kolaborasi real-time.</p>
                ...
                <div className="glass-card rounded-2xl overflow-hidden group fade-in-up" style={{ transitionDelay: '100ms' }}>
                    <Image src="https://placehold.co/600x400/1e1b4b/c084fc?text=Proyek+B" alt="Gambar Proyek B" width={600} height={400} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" />
                    <div className="p-6">
                ...
                <div className="glass-card rounded-2xl overflow-hidden group fade-in-up" style={{ transitionDelay: '200ms' }}>
                    <Image src="https://placehold.co/600x400/1e1b4b/a78bfa?text=Proyek+C" alt="Gambar Proyek C" width={600} height={400} className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300" />
                    <div className="p-6">
